...
Given node k. Return the time it takes for all the n nodes to receive the signal.
*/
...
var networkDelayTime = function (times, n, k) {
  const graph = new Map();
  // 1. Use u to v, weight to build a graph
  ...
  // time is the total time from current node to K
